		...
		agregar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(cadena.equals("") || cadena==null) {
					...
					campo_pass.requestFocusInWindow();
				...
				if(con.comprueba_usuario(usuario)==0 && con.comprueba_tipo_cuenta(Menu_Principal.usuario).equalsIgnoreCase("administrador")) {
					...
					JOptionPane.showMessageDialog(null, "El usuario " + usuario + " fue creado con éxito" );
					...
					}else if(!con.comprueba_tipo_cuenta(Menu_Principal.usuario).equalsIgnoreCase("administrador")) {
