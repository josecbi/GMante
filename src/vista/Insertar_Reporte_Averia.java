...
public class Insertar_Reporte_Averia extends JFrame{
	...
	public Insertar_Reporte_Averia(Menu_Principal padre, String titulo, boolean modal) {
		...
		this.setTitle("Insertar Reporte de Averías");
	...
	//----------------------------------------------Agregando otros componentes al frame-------------------------------------------------------------
		...
		JLabel label_t = new JLabel("Insertar Reporte de Averías");
		...
		//-----------------------------------------------Agregando boton Seleccionar Equipos----------------------------------------------------------------------
				...
				boton_equipo.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						Seleccionar_Equipos selec=new Seleccionar_Equipos(Insertar_Reporte_Averia.this, "Insertar Reporte de Avería", true);
					...
					class Seleccionar_Equipos extends JFrame{
						...
						public Seleccionar_Equipos(JFrame padre, String titulo, boolean modal) {
							...
							JLabel label_t=new JLabel("Seleccione equipos para reporte de avería");
							...
							seleccionar.addActionListener(new ActionListener() {
								...
								public void actionPerformed(ActionEvent e) {
									...
									try {
										...
										JOptionPane.showInternalMessageDialog(null, "Seleccione equipos para reporte de avería", "Infromación", JOptionPane.INFORMATION_MESSAGE);
		...
		agregar_causa.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(causas.getText()==null || causas.getText().equals("")) {
	...
	public JTextArea descripcion, descripcion_area;
