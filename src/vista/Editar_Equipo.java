...
public class Editar_Equipo extends JFrame{
	...
	public Editar_Equipo(JTable tabla) {			
		...
		JLabel codigo_equipo = new JLabel("Código: ");
		...
		JLabel numero_equipo = new JLabel("Número: ");
		...
		JLabel ubicacion_equipo = new JLabel("Ubicación: ");		
		...
		JButton boton_manual=new JButton("Cambiar Manual");
		...
		JButton boton_imagen=new JButton("Cambiar Imagen");
