...
public class Editar_Reporte_Averia extends JFrame{
	...
	public Editar_Reporte_Averia(JTable tabla) {
		...
		this.setTitle("Editar Reporte de Averías");
		...
		JLabel label_titulo=new JLabel("Editar Reporte de Averías");
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Seleccione un reporte de avería para editar.");			
		...
		JLabel label_descripcion=new JLabel("Descripción de Avería: ");
		...
		agregar_causa.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String causa_agregada=JOptionPane.showInputDialog("Introduzca una posible causa de avería:");
				
				if(causa_agregada==null || causa_agregada.equals("")) {
		...
		editar_causa.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String causa_editada=JOptionPane.showInputDialog("Edite la posible causa de avería seleccionada:", causa);
		...
		eliminar_causa.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int x=JOptionPane.showConfirmDialog(null, "Desea eliminar la posible causa de avería seleccionada?");
			...
			boton_equipos.addActionListener(new ActionListener() {
				...
				class Reporte_Equipos_Editar extends JFrame{
					...
					public Reporte_Equipos_Editar() {
						...
						this.setTitle("Equipo de Reporte de Avería");
						...
						JLabel label_t=new JLabel("Equipos de Reporte de Avería");
