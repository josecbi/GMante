...
public class Crear_Orden_Trabajo_Mantenimientos_Cercanos extends JFrame{
	
	public Crear_Orden_Trabajo_Mantenimientos_Cercanos(final JTable tabla_mantenimiento) {
		...
		seleccionar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showInternalMessageDialog(null, "Seleccione Empleado para realizar Orden de Trabajo", "Infromaci�n", JOptionPane.INFORMATION_MESSAGE);
				...
				int cantidad_equipos=Proximos_Mantenimientos.equipos.getRowCount();
				
				String ubicacion__equipo="";
				
				for(int i=0; i<cantidad_equipos; i++) {
					
					lista_ubicacion.add(Proximos_Mantenimientos.equipos.getValueAt(i, 3).toString());
				}
				...
				String fecha_terminado="Todavia";
				...
				Crear_Orden_Trabajo_Mantenimientos_Cercanos.this.setVisible(false);
