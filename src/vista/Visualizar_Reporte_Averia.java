...
public class Visualizar_Reporte_Averia extends JFrame implements WindowListener{
	...
	public Visualizar_Reporte_Averia() {
		...
		this.setTitle("Reporte de Averías");
		...
		JLabel t=new JLabel("Reportes de Averías");
		...
		//scroll_descripcion.setBorder(BorderFactory.createSoftBevelBorder(BevelBorder.LOWERED));
		...
		//scroll_causas.setBorder(BorderFactory.createSoftBevelBorder(BevelBorder.LOWERED));
		...
		editar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(tabla.getSelectedRowCount()>1) {
					...
					JOptionPane.showMessageDialog(null, "Seleccione solamente un Reporte de Avería para editar");
