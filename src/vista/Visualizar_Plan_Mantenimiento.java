...
public class Visualizar_Plan_Mantenimiento extends JFrame implements WindowListener{
	...
	public Visualizar_Plan_Mantenimiento() {
		...
		panel_tabla.setBorder(BorderFactory.createMatteBorder(0, 0, 0, 0, new Color(255,255,255)));
		...
		model=new DefaultTableModel(new String[] {"Nombre", "Marca", "Código", "Ubicación"},0);		
		...
		//scroll_tareas.setBorder(BorderFactory.createSoftBevelBorder(BevelBorder.LOWERED));
		...
		//scroll_herramientas.setBorder(BorderFactory.createSoftBevelBorder(BevelBorder.LOWERED));
		...
		//scroll_materiales.setBorder(BorderFactory.createSoftBevelBorder(BevelBorder.LOWERED));
		...
		JButton proximo=new JButton("Próximas 48 horas");
