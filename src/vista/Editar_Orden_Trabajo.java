...
public class Editar_Orden_Trabajo extends JFrame{
	...
	public Editar_Orden_Trabajo(JTable tabla) {
		...
		try {
			...
			if(fecha_terminado.equalsIgnoreCase("Todavía")) {
		...
		agregar_observaciones.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String observacion_agregada=JOptionPane.showInputDialog("Introduzca una nueva observación:");
				
				if(observacion_agregada==null || observacion_agregada.equals("")) {
		...
		editar_observacion.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String observacion_editada=JOptionPane.showInputDialog("Edite la observación seleccionada:", observacion);
		...
		eliminar_observacion.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int x=JOptionPane.showConfirmDialog(null, "Desea eliminar la observación seleccionada?");
