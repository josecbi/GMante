				...
				if(otro_archivo.exists()){
					 ...
					 String ruta_archivo=archivo.getAbsolutePath();
						...
						try {
							...
							Paragraph titulo = new Paragraph("Reportes de Averías \n\n");
						    ...
						    Paragraph cod_equipo = new Paragraph("Código Equipo");
						    ...
						    Paragraph ubi_equipo = new Paragraph("Ubicación Equipo");
							...
							if(num_filas>1 && tabla.getSelectedRows().length!=1) {				
							    ...
							    Paragraph titulo_causas = new Paragraph("Posibles causas de la Avería:");			    		
							...
							JOptionPane.showMessageDialog(null, "Seleccione un Reporte de Avería para exportar.");
							
							return;
							
						}
						
						JOptionPane.showMessageDialog(null, "Reporte de Avería exportados con éxito.", null, JOptionPane.INFORMATION_MESSAGE);
