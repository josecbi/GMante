...
public class Evento_Editar_Orden_Trabajo implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showInternalMessageDialog(null, "Falta por llenar el campo fecha inicio", "Infromación", JOptionPane.WARNING_MESSAGE);
				...
				try {
					...
					System.out.println(fecha_terminado);
				...
				try {
					...
					for(int i=0; i<Visualizar_Orden_Trabajo.equipos.getRowCount(); i++) {				
						...
						System.out.println("error aquí "+i);
