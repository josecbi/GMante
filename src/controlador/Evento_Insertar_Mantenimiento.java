...
public class Evento_Insertar_Mantenimiento implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			JOptionPane.showInternalMessageDialog(null, "Falta por llenar el campo Fecha ", "Información", JOptionPane.WARNING_MESSAGE);
		...
		if(lista_tareas.get(0).toString().equals("\n")) {
			
			lista_tareas.remove(0);
		...
		if(lista_herramientas.get(0).toString().equals("\n")) {
			
			lista_herramientas.remove(0);
		...
		if(lista_materiales.get(0).toString().equals("\n")) {
			
			lista_materiales.remove(0);
		...
		if(plan.avanzado) {
			...
			fd=(int)plan.frecuencia_dia.getValue();		
			fm=(int)plan.frecuencia_mes.getValue();		
			fa=(int)plan.frecuencia_agno.getValue();
			
		}
		
		if(plan.estandar) {
			
			if(plan.frecuencia_estandar.getSelectedItem().toString().equals("Ninguna")) {
				
				fd=0;
				fm=0;
				fa=0;				
				
			}else if(plan.frecuencia_estandar.getSelectedItem().toString().equals("1 Mes")) {
				
				fd=0;
				fm=1;
				fa=0;
				
			}else if(plan.frecuencia_estandar.getSelectedItem().toString().equals("2 Meses")) {
				
				fd=0;
				fm=2;
				fa=0;
				
			}else if(plan.frecuencia_estandar.getSelectedItem().toString().equals("3 Meses")) {
				
				fd=0;
				fm=3;
				fa=0;
				
			}else if(plan.frecuencia_estandar.getSelectedItem().toString().equals("6 Meses")) {
				
				fd=0;
				fm=6;
				fa=0;
				
			}else if(plan.frecuencia_estandar.getSelectedItem().toString().equals("1 Año")) {
				
				fd=0;
				fm=0;
				fa=1;
				
			}else if(plan.frecuencia_estandar.getSelectedItem().toString().equals("2 Años")) {
				
				fd=0;
				fm=0;
				fa=2;
				
			}else if(plan.frecuencia_estandar.getSelectedItem().toString().equals("3 Años")) {
		...
		try {
			...
			if(lista_equipos.size()==0) {
				...
				JOptionPane.showInternalMessageDialog(null, "Seleccione equipos para mantenimiento", "Información", JOptionPane.INFORMATION_MESSAGE);
				
				return;
			}
			
			if(lista_equipos.get(0).toString().equals("\n")) {
				
				lista_equipos.remove(0);
		...
		if(tpm==0 && tph==0 && tpd==0) {			
			...
			JOptionPane.showMessageDialog(null, "Agregue Tiempo de Preparación.");
		...
		JOptionPane.showMessageDialog(null, "Plan de Mantenimiento guardado con éxito.");
