...
public class Evento_Insertar_Reporte_Averia implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			JOptionPane.showInternalMessageDialog(null, "Falta por llenar el campo Fecha reporte", "Infromación", JOptionPane.WARNING_MESSAGE);
		...
		try {
			...
			JOptionPane.showInternalMessageDialog(null, "Seleccione equipos para Reporte de Averías", "Infromación", JOptionPane.INFORMATION_MESSAGE);
		...
		if(descripcion==null || descripcion.equals("\n")) {
			...
			JOptionPane.showMessageDialog(null, "Falta por llenar el campo Descripción de Avería");
		...
		JOptionPane.showMessageDialog(null, "Reporte de Avería guardado.");
