...
public class Agregar_Equipos_En_Editar_Plan_Mantenimiento extends JDialog{
	
	
	public Agregar_Equipos_En_Editar_Plan_Mantenimiento(String [] codigos) {
		...
		this.setTitle("Editar Equipos de Plan de Mantenimiento");
		...
		JLabel t=new JLabel("Agregar equipos al Plan Mantenimiento");
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				DefaultTableModel dtm=(DefaultTableModel)Editar_Plan_Mantenimiento.editar_equipos.getModel();
				...
				if (fila == -1) {
					...
					int x=JOptionPane.showConfirmDialog(null, "Desea agregar al mantenimiento los equipos seleccionados?");
				...
				Editar_Plan_Mantenimiento.modelo_equipo_editar=dtm;
				
				Editar_Plan_Mantenimiento.editar_equipos.setModel(Editar_Plan_Mantenimiento.modelo_equipo_editar);
				
				
				
				Editar_Plan_Mantenimiento.editar_equipos.getColumnModel().getColumn(7).setMaxWidth(0);
				Editar_Plan_Mantenimiento.editar_equipos.getColumnModel().getColumn(7).setMinWidth(0);
				Editar_Plan_Mantenimiento.editar_equipos.getTableHeader().getColumnModel().getColumn(7).setMaxWidth(0);
				Editar_Plan_Mantenimiento.editar_equipos.getTableHeader().getColumnModel().getColumn(7).setMinWidth(0);
				
				
				Editar_Plan_Mantenimiento.editar_equipos.getColumnModel().getColumn(8).setMaxWidth(0);
				Editar_Plan_Mantenimiento.editar_equipos.getColumnModel().getColumn(8).setMinWidth(0);
				Editar_Plan_Mantenimiento.editar_equipos.getTableHeader().getColumnModel().getColumn(8).setMaxWidth(0);
				Editar_Plan_Mantenimiento.editar_equipos.getTableHeader().getColumnModel().getColumn(8).setMinWidth(0);
				
				
				Agregar_Equipos_En_Editar_Plan_Mantenimiento.this.setVisible(false);
