...
public class Login extends JFrame{
	...
	public Login() {
		...
		this.setTitle("Insertar Password");
		...
		panel_componentes_padre.setBorder(new EmptyBorder(0, 0, (int) (dim.height*0.07), (int) (dim.width*0.07)));
		...
		JLabel label_t = new JLabel("Insertar Usuario y Password");
		...
		boton_aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String pass=String.valueOf(caracteres);
					...
					JOptionPane.showMessageDialog(null, "Usuario o password incorrecto", null, JOptionPane.WARNING_MESSAGE);
