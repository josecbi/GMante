...
public class Evento_Insertar_Equipo implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(marca.equals("")) {
			...
			JOptionPane.showMessageDialog(null, "El campo 'Marca' esta vacio", "Informacion", JOptionPane.INFORMATION_MESSAGE);
		...
		if(modelo.equals("")) {
			...
			JOptionPane.showMessageDialog(null, "El campo 'Modelo' esta vacio", "Informacion", JOptionPane.INFORMATION_MESSAGE);
		...
		if(numero.equals("")) {
			...
			JOptionPane.showMessageDialog(null, "El campo 'Numero' esta vacio", "Informacion", JOptionPane.INFORMATION_MESSAGE);
		...
		if(estado.equals("")) {
			...
			JOptionPane.showMessageDialog(null, "El campo 'Estado' esta vacio", "Informacion", JOptionPane.INFORMATION_MESSAGE);
		...
		if(ubicacion.equals("")) {
			...
			JOptionPane.showMessageDialog(null, "El campo 'Ubicacion' esta vacio", "Informacion", JOptionPane.INFORMATION_MESSAGE);
