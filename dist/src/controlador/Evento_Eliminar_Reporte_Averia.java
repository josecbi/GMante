...
public class Evento_Eliminar_Reporte_Averia implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (fila == -1) {
			...
			JOptionPane.showMessageDialog(null, "Seleccione un reporte de averia para eliminar.", "Elija reporte de averia",
			...
			int x=JOptionPane.showConfirmDialog(null, "Desea eliminar el reporte de averia seleccionado?");
		...
		JOptionPane.showMessageDialog(null, "Reporte de Averia eliminado.");
